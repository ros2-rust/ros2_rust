...
//!            "in_topic",
//!            |_msg: StringMsg| { todo!("Assign msg to self.data") },
//!        )?;
//!        Ok(Self {
//!            _node,
//!            _subscription,
...
//! we also need a `Mutex` or a `RefCell`. This `Arc<Mutex<T>>` type is a frequent pattern in Rust code.
//!
