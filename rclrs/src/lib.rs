...
// Lets the code generated by `#[derive(ParameterSet)]` refer to `::rclrs` even when it is
// expanded inside this crate, as it is by the tests and doc examples here.
extern crate self as rclrs;
